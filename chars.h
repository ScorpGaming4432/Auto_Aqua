...
const uint8_t MASTER_LIBRARY[][8] PROGMEM = {
  ...
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ы (16) \220
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ъ (17) \221
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ё (18) \222
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // Ч (19) \223
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ь (20) \224

  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ü (21) \225
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ä (22) \226

  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ç (23) \227
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // é (24) \230
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // â (25) \231

  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ñ (26) \232
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // í (27) \233
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // á (28) \234

  { 0, 0, 0, 0, 0, 0, 0, 0 },  // à (29) \235

  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ê (30) \236
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ã (31) \237

  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ı (32) \240
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ş (33) \241
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ğ (34) \242
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ö (35) \243
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // İ (36) \244

  { 0, 0, 0, 0, 0, 0, 0, 0 },  // Č (37) \245
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // š (38) \246
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ž (39) \247
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ý (40) \250
  { 0, 0, 0, 0, 0, 0, 0, 0 },  // ú (41) \251
  { 0, 0, 0, 0, 0, 0, 0, 0 }   // ě (42) \252
};

// Automatically calculate the number of rows in the library
